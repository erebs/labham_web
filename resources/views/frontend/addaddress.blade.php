...
<div class="container-main">
  <section class="add-addres">
    <h3  class="text-center pb-5 add-address-main-head">Add New Address</h3>
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pb-3">
        <div class="form-group">
          <input placeholder="name" id="name" class="form-control" type="text">
        </div>
      </div>
      <div class="col-xs-12  col-sm-12 col-md-6 col-lg-6 pb-3">
        <div class="form-group">
          <input  placeholder="Mobile number" id="mobile" class="form-control" type="number">
        </div>
      </div>
      <div class="col-lg-12 pb-3">
        <div class="form-group">
         <textarea style="width: 100%;padding: 10px 10px;border: 0.3px solid grey !important;border-radius: 10px;" name="" id="address"  rows="4">Address</textarea>
        </div>
      </div>
      <div style="padding-left: 0;padding-right: 0;" class="col-xs-12  col-sm-12 col-md-6 col-lg-6 pb-3">
        <div class="form-group">
          <div class="col-lg-12">
           <input  placeholder="District" id="dist" class="form-control" type="text">
          </div>
        </div>
      </div>
      <div style="padding-left: 0;padding-right: 0;" class="col-xs-12  col-sm-12 col-md-6 col-lg-6 pb-3">
        <div class="form-group">
          <div class="col-lg-12">
            <input  placeholder="State" id="st" class="form-control" type="text">
          </div>
        </div>
      </div>
    <!--   <div style="padding-left: 0;padding-right: 0;" class="col-xs-12  col-sm-12 col-md-6 col-lg-6 pb-3">
      ...
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  pb-3">
        <div class="form-group">
          <input placeholder="Pincode" id="pincode" class="form-control" type="number">
        </div>
      </div>
      <div class="col-xs-12  col-sm-12 col-md-6 col-lg-6  pb-3">
        <div class="form-group">
          <input  placeholder="Landmark" id="land" id="text" class="form-control" type="text">
        </div>
      </div>
			<div class="col-lg-12">
				<button type="button" onclick="AddAddress()" id="ab1" class="labham-primary-bg btn btn-add-address text-white">Add</button>
				<button type="button" id="ab2" class="labham-primary-bg btn btn-add-address text-white"><i class="fa fa-spinner fa-spin"></i>  Add</button>
			</div>
    </div>
  </section>
</div>
