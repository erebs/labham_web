      ...
      <div class="col-12">
        <div class="card card-primary">
          <!-- <div class="card-header">
            <h3 class="card-title">Middle Images</h3>
          </div> -->
          <div class="card-body">
                    ...
                    <td align="center">
                      <div class="row">
                        ...
                        <div class="col-sm-6" align="left">
                          <form action="{{url('/admin/banners/delete/second/'.$value->id)}}" method="POST" role="form">
                            {!! csrf_field() !!}
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form action="{{url('/admin/banners/create')}}" method="POST" id="addform" role="form" enctype="multipart/form-data">
          ...
          <input type="hidden" name="redi" value="second">
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Image in Ratio of 4:1 Required, ie Resolution 2000 x 500px, 1600 x 400px ..etc.">
    ...
    if ((file = this.files[0])) {
      ...
      img.onload = function () {
        ...
        if (res < 3.95 || res > 4.05) {
          ...
          $('#helpImage').html('Image in Ratio of 4:1 Required, ie Resolution 2000 x 500px, 1600 x 400px ..etc.').removeClass('hide');
        } else {
