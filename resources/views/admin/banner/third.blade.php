      ...
      <div class="col-12">
        <div class="card card-primary">
          <!-- <div class="card-header">
            <h3 class="card-title">Footer Images</h3>
          </div> -->
          <div class="card-body">
                    ...
                    <td align="center">
                      <div class="row">
                        <div class="col-sm-6" align="right">
                          <a href="" class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-add" title="Edit Banner" onclick="mkeEditForm('{{$value->id}}','{{$value->image}}','{{$value->name}}','{{$value->url}}')">
                            <i class="fa fa-edit text-warning" style="font-size:16px"></i>
                          </a>
                        </div>
                        <div class="col-sm-6" align="left">
                          <form action="{{url('/admin/banners/delete/third/'.$value->id)}}" method="POST" role="form">
                            {!! csrf_field() !!}
                            <button type="submit" class="btn btn-sm btn-default" title="Delete Banner">
                              <i class="fa fa-trash text-danger" style="font-size:16px" aria-hidden="true"></i>
                            </button>
                          </form>
                        </div>
                      </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form action="{{url('/admin/banners/create')}}" method="POST" id="addform" role="form" enctype="multipart/form-data">
          ...
          <input type="hidden" name="redi" value="third">
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Image in Ratio of 2:1 Required, ie Resolution 600 x 300px, 500 x 250px ..etc.">
  ...
  $('#image').change(function (e) {
    ...
    if ((file = this.files[0])) {
      ...
      img.onload = function () {
        ...
        if (res < 1.85 || res > 2.15) {
          $('#image').addClass('is-invalid').val('');
          $('#showImage').addClass('hide');
          $('#helpImage').html('Image in Ratio of 2:1 Required, ie Resolution 600 x 300px, 500 x 250px ..etc.').removeClass('hide');
        } else {
