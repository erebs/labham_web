                    ...
                    <td align="center">
                      <div class="row">
                        ...
                        <div class="col-sm-6" align="left">
                          <form action="{{url('/admin/banners/delete/fourth/'.$value->id)}}" method="POST" role="form">
                            {!! csrf_field() !!}
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form action="{{url('/admin/banners/create')}}" method="POST" id="addform" role="form" enctype="multipart/form-data">
          ...
          <input type="hidden" name="redi" value="fourth">
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Image in Aspect Ratio of 2:1 Required, ie Resolution 1000 * 500px, 600 * 300px ..etc.">
  ...
  $('#image').change(function (e) {
    ...
    if ((file = this.files[0])) {
      ...
      img.onload = function () {
        ...
        if (res < 1.95 || res > 2.05) {
          $('#image').addClass('is-invalid').val('');
          $('#showImage').addClass('hide');
          $('#helpImage').html('Image in Aspect Ratio of 2:1 Required, ie Resolution 1000 * 500px, 600 * 300px ..etc.').removeClass('hide');
        } else {
