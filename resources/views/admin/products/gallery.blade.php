                    ...
                    <td align="center">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6" align="left">
                          <form action="{{url('/admin/prod-gallery-delete/'.$value->id.'/'.$pid)}}" method="POST" role="form" id="delform{{$value->id}}">
                            {!! csrf_field() !!}
      ...
      <div class="modal-content">
        <form action="{{url('/admin/prod-gallery-create')}}" method="POST" id="addform" role="form" enctype="multipart/form-data">
          ...
          <div class="modal-header">
            <h4 class="modal-title" id="bannerHeading">Add New Image</h4>
...
<script>
  ...
  function mkeAddForm() {
    ...
    $('#addform').attr('action', '{{url('/admin/prod-gallery-create')}}');
    $('#name,#id').val('');
